...
public class GaussianTemplateReader implements GridTemplateReader{
	...
	public GDSTemplate readTemplate(byte[] gdsValues, int headerOffSet) throws BinaryNumberConversionException {
		...
		gaussianTemplate.setScaleFactorRadiusEarth(readScaleFactorRadiusEarth(gdsValues, headerOffSet));
		...
		gaussianTemplate.setScaledValueMajorAxisOblateSphericalEarth(readScaleValueMajorAxisEarth(gdsValues, headerOffSet));
		
		gaussianTemplate.setScaleFactorMinorAxisOblateSphericalEarth(readScaleFactorMinorAxisEarth(gdsValues, headerOffSet));
		...
		gaussianTemplate.setNi(readNi(gdsValues, headerOffSet));
		gaussianTemplate.setNj(readNj(gdsValues, headerOffSet));
		
		gaussianTemplate.setLa1(readLa1(gdsValues, headerOffSet));
		gaussianTemplate.setLo1(readLo1(gdsValues, headerOffSet));
		...
		gaussianTemplate.setNumberOfParallelsBetweenPoleAndEquator(readNumberOfParallelsPoleEquator(gdsValues, headerOffSet));
		
		// TODO Handle Resolution and component flags
		
		// TODO Add condition for missing NumberOfPointsAlongParallel
		gaussianTemplate.setNumberOfPointsAlongParallel(
				readNumberOfPointsPerParallel(gdsValues, headerOffSet, gaussianTemplate.getNumberOfParallelsBetweenPoleAndEquator() * 2));
